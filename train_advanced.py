...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='data/Mechanical-datasets', help='the directory of the data')
    ...
    parser.add_argument('--bottleneck_num', type=int, default=512, help='whether using the bottleneck layer')
    ...
    parser.add_argument('--distance_loss', type=str, choices=['MK-MMD', 'JMMD', 'CORAL'], default='None', help='which distance loss you use')
    ...
    parser.add_argument('--adversarial_loss', type=str, choices=['DA', 'CDA', 'CDA+E'], default='None', help='which adversarial loss you use')
    ...
    parser.add_argument('--middle_epoch', type=int, default=250, help='max number of epoch')
